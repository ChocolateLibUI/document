var h=Object.defineProperty;var b=(a,t,e)=>t in a?h(a,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):a[t]=e;var l=(a,t,e)=>(b(a,typeof t!="symbol"?t+"":t,e),e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function e(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerpolicy&&(n.referrerPolicy=i.referrerpolicy),i.crossorigin==="use-credentials"?n.credentials="include":i.crossorigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=e(i);fetch(i.href,n)}})();let m=`
<header>
...
</svg>`;class g{constructor(t,e,s){l(this,"type");l(this,"target");l(this,"data");this.type=t,this.target=e,this.data=s}}class u{constructor(){l(this,"target");l(this,"eventHandler_ListenerStorage",{})}on(t,e){let s=this.eventHandler_ListenerStorage[t];return s?s.indexOf(e)==-1?s.push(e):console.warn("Listener already in handler"):this.eventHandler_ListenerStorage[t]=[e],e}once(t,e){return this.on(t,function(s){return e(s),!0}),e}off(t,e){let s=this.eventHandler_ListenerStorage[t];if(s){let i=s.indexOf(e);i!=-1?s.splice(i,1):console.warn("Listener not in handler")}return e}emit(t,e){let s=this.eventHandler_ListenerStorage[t];if(s&&s.length>0){let i=Object.freeze(new g(t,this.target||this,e));s.length>1&&(s=[...s]);for(let n=0,o=s.length;n<o;n++)try{s[n](i)&&(s.splice(n,1),o--,n--)}catch(c){console.warn("Failed while dispatching event",c)}}}clear(t){this.eventHandler_ListenerStorage[t]=[]}inUse(t){var e;return Boolean((e=this.eventHandler_ListenerStorage[t])==null?void 0:e.length)}has(t,e){var s;return Boolean(((s=this.eventHandler_ListenerStorage[t])==null?void 0:s.indexOf(e))!==-1)}amount(t){var e;return((e=this.eventHandler_ListenerStorage[t])==null?void 0:e.length)||0}get eventsUserOnly(){return this}}class p{constructor(t){l(this,"_documents");l(this,"main");l(this,"_events");l(this,"events");this.main=t,this._documents=[t],this._events=new u,this._events.target=this,this.events=this._events.eventsUserOnly}forDocuments(t){for(let e=0;e<this._documents.length;e++)t(this._documents[e])}get documents(){return[...this._documents]}registerDocument(t,e){if(this._documents.includes(t))return console.warn("Document registered twice");if(this._documents.push(t),e){let s=this.main.head.children;for(let i=0;i<s.length;i++)switch(s[i].nodeName){case"LINK":if(s[i].rel!=="stylesheet")break;case"STYLE":t.head.appendChild(s[i].cloneNode(!0));break}}this._events.emit("added",t)}deregisterDocument(t){let e=this._documents.indexOf(t);if(e==-1)return console.warn("Document not registered");if(this._documents[e]===this.main)return console.warn("Main document cannot be removed");this._documents.splice(e,1),this._events.emit("removed",t)}}let d=new p(document);d.events.on("added",a=>{console.warn("Doc Added")});d.events.on("removed",a=>{console.warn("Doc Removed")});let r=a=>{let t=document.createElement("button");t.innerHTML="Test",t.onclick=()=>{f()},a.innerHTML=m,a.prepend(t)},f=()=>{let a=window.open("","","popup");d.registerDocument(a.document,!0),a==null||a.addEventListener("unload",()=>{d.deregisterDocument(a.document)}),a.document.body&&r(a.document.body)};r(document.body);
